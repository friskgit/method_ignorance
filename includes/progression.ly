...
%%%%%%%%%% 11 4/4 %%%%%%%%%%%
	...
	prog_fin = {
		...
		{ <guba'' doca''>1 }
		\\
		{s4\sustainOn \cue "42" s2 s4 \sustainOff }
	    >>
...
prog_d_ct = {
    r2
    \ottava #1
    <csoaa''' fsoda''' gsoaa'''>4. \sustainOn \cue "43"
    r8 
    |
%%%%%%%%%% 13 %%%%%%%%%%%
...
%%%%%%%%%% 15 3/4 %%%%%%%%%%%
    r4.
    <fsoda'' csoaa''' gsoaa'''>4.~ \sustainOn \cue "44"
    |
%%%%%%%%%% 16 4/4 %%%%%%%%%%%
    <fsoda'' csoaa''' gsoaa'''>8 \sustainOff 
    r4.
    <doba''' fsoda''' csoaa'''>2~ \sustainOn \cue "45"
    |
%%%%%%%%%% 17 5/8 %%%%%%%%%%%
    ...
    |
%%%%%%%%%% 18 3/4 %%%%%%%%%%%
    <doba'' guba'' gsoaa''>2.\fermata \sustainOn \cue "46"
    |
%%%%%%%%%% 19 3/8 %%%%%%%%%%%
    r4. \sustainOff 
    \ottava #0
...
prog_fin_end_ct = {
        gsoaa4 \mark \markup {\sans \fontsize #6 \box \bold \raise #10 "Coda"}
	    guba8 gsoaa8~
        gsoaa4~ \tuplet 3/2 {gsoaa8 guba4~}
        |
    %%%%%%%%%% 2 %%%%%%%%%%%
        r2
        r8 gsoaa4 guba16 gsoaa16~
        |
    %%%%%%%%%% 3 %%%%%%%%%%%
    ...
    %%%%%%%%%% 4 %%%%%%%%%%%
        \tuplet 3/2 {
    	gsoaa''4 doba4. csoaa8~
        }
        csoaa8 doba8 <csoaa doba>4->~
        |
    %%%%%%%%%% 5 %%%%%%%%%%%
        \tuplet 3/2 {<csoaa doba>4 <csoaa doba>4. gsoaa8~ }
        \tuplet 3/2 {gsoaa8 guba4 <gsoaa guba>4 gsoaa8~}
        |
    %%%%%%%%%% 6 %%%%%%%%%%%
        gsoaa4 guba4~ guba8 gsoaa8~ gsoaa4~
	|
	%%%%%%%%%% 7 %%%%%%%%%%%
	gsoaa2\p r8 <doba'' fsoda''>4.~\mp
	|
	%%%%%%%%%% 8 %%%%%%%%%%%
	  <doba'' fsoda''>1
	|
